...
const strings = new LocalizedStrings({
    ...
    ru: {
        ...
        profile: "Профиль",
        statistics: "Статистика",
        pie_title: "Свободные и занятые дни",
        doughnut_title: "Активные, выполненные и пропущенные задачи",
        line_title: "Количество задач в день",
        zero_tasks_verdict: "У вас 0 активных задач. Время работать :)",
        good_verdict: "Вы отлично планируете!",
        bad_verdict: "Исходя из количества задач, которые у вас есть, мы можем предположить, что вы устанете. Советуем вам перераспределить задачи",
        from: "с",
        to: "по",
        free_days: "Свободные дни",
        busy_days: "Занятые дни",
        active: "Активные",
        completed: "Выполненные",
        missed: "Пропущенные",
        count_of_tasks: "Количество задач",
        logout: "Выйти",
        updating: "Обновление",
        username: "Имя",
        image: "Изображение",
